...
export const TRANSLATIONS = {
    ru: {
        ...
        coffee_gate_desc: "Вы сыграли уже 10 вопросов! Мы делаем эту игру с любовью и без рекламы. Если вам нравится, поддержите разработчика и купите кофе за $5 на всю компанию",
        ...
        ai_pay_desc: "Генерация вопросов с помощью искусственного интеллекта Gemini расходует ресурсы сервера. Чтобы разблокировать эту функцию на всё время существования комнаты, поддержите разработчика на $5! Это поможет нам оплачивать API и развивать игру",
        ai_pay_btn: "Оплатить доступ ($5)",
        ai_pay_code_hint: "Важно: укажите код комнаты {code} в сообщении к поддержке — так мы поймём, что оплата ваша.",
    ...
    en: {
        ...
        coffee_gate_desc: "You have played 10 questions! We make this game with love and no ads. If you enjoy it, please support the developer and buy a coffee for $5 for the whole company",
        ...
        ai_pay_desc: "Generating questions using Gemini AI consumes server resources. To unlock this feature for the entire lifetime of this room, please support the developer for $5! This helps us pay for the API and develop the game",
        ai_pay_btn: "Unlock Access ($5)",
        ai_pay_code_hint: "Important: include room code {code} in your support message — that's how we'll know the payment is yours.",
    ...
    uk: {
        ...
        coffee_gate_desc: "Ви зіграли вже 10 питань! Ми робимо цю гру з любов'ю та без реклами. Якщо вам подобається, підтримайте розробника та купіть каву за $5 на всю компанію",
        ...
        ai_pay_desc: "Генерація питань за допомогою штучного інтелекту Gemini витрачає ресурси сервера. Щоб розблокувати цю функцію на весь час існування кімнати, підтримайте розробника на $5! Це допоможе нам оплачувати API та розвивати гру",
        ai_pay_btn: "Оплатити доступ ($5)",
        ai_pay_code_hint: "Важливо: вкажіть код кімнати {code} у повідомленні до підтримки — так ми зрозуміємо, що оплата ваша.",
    ...
    pl: {
        ...
        coffee_gate_desc: "Zagraliście już 10 pytań! Tworzymy tę grę z miłością i bez reklam. Jeśli wam się podoba, wesprzyjcie twórcę i kupcie kawę za 5$ dla całej grupy",
        ...
        ai_pay_desc: "Generowanie pytań za pomocą sztucznej inteligencji Gemini zużywa zasoby serwera. Aby odblokować tę funkcję na cały czas istnienia pokoju, wesprzyj twórcę kwotą 5$! Pomaga nam to opłacać API i rozwijać grę",
        ai_pay_btn: "Odblokuj dostęp ($5)",
        ai_pay_code_hint: "Ważne: podaj kod pokoju {code} w wiadomości do wsparcia — dzięki temu wiemy, że to Twoja wpłata.",
