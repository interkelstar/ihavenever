...
const Footer: React.FC = () => {
    return (
        <footer className="main-footer">
            <span>
                <span>by kelstar</span>
                <a href="https://github.com/interkelstar" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://twitter.com/kelstar_" target="_blank" rel="noopener noreferrer">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
                ...
                <a href="https://instagram.com/interkelstar" target="_blank" rel="noopener noreferrer">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
                ...
                <a href="https://t.me/kelstar" target="_blank" rel="noopener noreferrer">
                    <svg width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
